...
//    Map indexMap = new HashMap();
     ...
     * put method
     */
    public synchronized MessageEntity  putMessage(MessageEntity messageEntity) {
...
//        messageEntity.partition = partition++;
        ...
        notify();
        log.info("add message to message queue success  {}",topic+new String(messageEntity.messages));
